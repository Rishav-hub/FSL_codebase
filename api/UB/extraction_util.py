...
def load_model(device):
    try:
        ...
        non_table_processor = AutoProcessor.from_pretrained("Laskari-Naveen/UB_2_P1")
        non_table_model = VisionEncoderDecoderModel.from_pretrained("Laskari-Naveen/UB_2_P1")
        non_table_model.eval().to(device)
        print("Non Table Model loaded successfully")
        table_processor = AutoProcessor.from_pretrained("Laskari-Naveen/UB_2_P2")
        table_model = VisionEncoderDecoderModel.from_pretrained("Laskari-Naveen/UB_2_P2")
