...
CATEGORY_MAPPING_PATH = r'/Data/FSl_ML/FSL_codebase/api/UB/artifact/notes.json'

MODEL_PATH = r'/Data/FSl_ML/FSL_codebase/api/UB/artifact/ub__100.pth'

UB_FORM_KEY_MAPPING = r"/Data/FSl_ML/FSL_codebase/api/UB/artifact/FSL_Forms_Keys.xlsx"

UB_AVERAGE_COORDINATE_PATH = r"/Data/FSl_ML/FSL_codebase/api/UB/artifact/average_coordinates_ub.xlsx"
...
BBOX_DONUT_Mapping_Dict = {'1_Bill_Prov_Details': ['1_BillProvAddr1',
 ...
 '79_OTHER_DETAILS': ['79_OthProvFName',
  ...
  '79_OthProvOthId',
  '79_OthProvQualId'],
 '80_REMARKS': '80_NYSurCharge',
 '81_Label': ['81A_AddtlCodeValue',
  '81B_AddtlCodeInd',
  '81B_AddtlCodeValue',
  '81C_AddtlCodeInd',
  '81C_AddtlCodeValue',
...
def load_model(device):
    try:
        ...
        non_table_processor = AutoProcessor.from_pretrained("Laskari-Naveen/ub_last_v1")
        non_table_model = VisionEncoderDecoderModel.from_pretrained("Laskari-Naveen/ub_last_v1", cache_dir= "/Data/FSl_ML")
        non_table_model.eval().to(device)
        print("Non Table Model loaded successfully")
        table_processor = AutoProcessor.from_pretrained("Laskari-Naveen/UB_99_P2")
        table_model = VisionEncoderDecoderModel.from_pretrained("Laskari-Naveen/UB_99_P2", cache_dir= "/Data/FSl_ML")
