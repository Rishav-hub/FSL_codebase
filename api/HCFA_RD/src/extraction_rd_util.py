...
CATEGORY_MAPPING_PATH = r'/Data/FSl_ML/FSL_codebase/api/HCFA_RD/artifacts/hcfa_rd_notes_grouped_v2.json'

HCFA_RD_MODEL_PATH = r'/Data/FSl_ML/FSL_codebase/api/HCFA_RD/artifacts/hcfa_rd_grouped_30.pth'
...
def load_model(device):
    try:
        processor = AutoProcessor.from_pretrained("Laskari-Naveen/hcfa_rd_v1", cache_dir= "/Data/FSl_ML")
        model = VisionEncoderDecoderModel.from_pretrained("Laskari-Naveen/hcfa_rd_v1", cache_dir= "/Data/FSl_ML")
